  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-10">
      ...
      <h2 className="text-3xl font-bold text-center mb-8">
        About Harifly Centres
      </h2>

      {/* Content */}
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <p>
          <strong>Harifly  and Pathshalla Centres in India</strong>
        </p>
        <p>
          Harifly is an affordable educational platform in India. It offers
          two types of classes for students:, which is offline, and
        ...
        <p>
          Currently, PW has over 150  and Pathshala centres across 20
        ...
        <p>
          Pathshala offer a unique learning environment with
        ...
        <p>
          Harifly at  Pathshala provides several advantages to
        ...
        <div className="space-y-4">
          ...
          <p>
           ...
           Harifly centres offer offline learning to its students in hi-tech
