...
const AppPromoSection = () => {
  return (
      ...
      <div className="max-w-6xl py-4 mx-6 xl:mx-auto rounded-2xl my-8 bg-[#000080]  px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-0 lg:gap-10">
