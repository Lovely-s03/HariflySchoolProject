...
//   return (
//     <section className="relative bg-gradient-to-r from-[#f5f7ff] to-[#f9fbff] pb-32">
...
//               Bharat’s{" "}
//               <span className="text-purple-600">Trusted &</span>{" "}
//               <span className="text-blue-600">Affordable</span>{" "}
...
//             </p>
//             <button className="mt-6 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg shadow-md transition">
//               Get Started
//             </button>
//           </div>
...
//               <div className="w-40 h-40 rounded-full bg-white shadow-lg flex items-center justify-center border-2 border-purple-200">
//                 <img
//                   src={pandey}
//                   alt="Alakh Sir"
...
//                 />
//               </div>
//               <div className="absolute -bottom-10 -left-4 bg-purple-700 text-white px-4 py-2 rounded-lg shadow-md text-sm w-60">
...
//               {/* Chat Bubble */}
//               <div className="absolute -top-6 -right-4 bg-white border px-3 py-1 rounded-full shadow text-sm">
...
//           <div className="flex flex-col items-center justify-center p-6 text-center relative after:content-[''] after:absolute after:top-1/2 after:right-0 after:translate-y-[-50%] after:w-px after:h-12 after:bg-gray-300 ">
