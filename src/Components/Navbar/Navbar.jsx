...
//                 className="w-full flex justify-between items-center px-3 py-2 font-medium text-[#000080]"
//               >
//                 All Course{" "}
//                 <FiChevronDown
//                   className={`ml-2 transform transition-transform ${mobileDropdownOpen ? "rotate-180" : ""}`}
//                 />
//               </button>
//               {mobileDropdownOpen && (
...
//           <Link to="/about-us" className="text-sm font-medium text-[#000080]">About</Link>
//           <Link to="center" className="text-sm font-medium text-[#000080]">Centers</Link>
//           <button
...
//           <button
//             onClick={() => setOpen(true)}
//             className="bg-[#000080] text-white px-3 py-1 rounded-md text-sm"
//           >
//             Login
//           </button>
//         </div>
...
//         {mobileCoursesOpen && (
//           <div className="lg:hidden fixed bottom-12 left-0 w-full bg-white shadow-lg border-t z-50 p-4 max-h-[60vh] overflow-y-auto">
//             <DropdownMenu />
//           </div>
//         )}
