...
const GreatPlaceSection = () => {
  return (
    <section className="relative max-w-6xl m-auto mt-12 mb-20">
      {/* Main card */}
      <div className="bg-gradient-to-r from-indigo-50 to-blue-100 text-gray-900 rounded-2xl mx-6 xl:mx-0 px-6 lg:px-12 py-8 relative">
      ...
      <div className="absolute -top-12 right-8 md:top-5 md:right-16 scale-125 md:scale-150  overflow-hidden bg-gradient-to-b from-white to-[#f9f9fad2] hidden lg:block">
